...
$works = [
    [
        ...
        "dateStart" => "март 2021",
        "dateEnd" => "август 2022",
        "description" => "Работал оператором в колл-центре на дому. Работал в компании Яндекс.Драйв. 
        Консультировал и помогал пользователям в проблемах связанных с автомобилями и пользованием самим приложением",
    ],
    [
      "name" => "Инженер 1 категории",
      "dateStart" => "Сентябрь 2021",
      "dateEnd" => "по настоящее время",
      "description" => "Работаю инженером в МБУ Северное, заполняю отчетность, веду журналы по содержанию и обслуживанию, 
      принимаю входящие звонки, а также взаимодействую с различными департаментами города Волгограда",
  ],
];
